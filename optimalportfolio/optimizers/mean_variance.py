...
class MeanVariance:
    def __init__(self, n, exp_ret, cov, tickers, weight_bounds=(0, 1)):
        """
    ...
    #     self.skew = skew
    #     self.kurt = kurt
    #     args = (self.exp_ret, self.cov, skew, kurt, delta1, delta2, delta3, delta4)
    ...
    #     self.coskew = coskew
    #     self.cokurt = cokurt
    #     args = (self.exp_ret, self.cov, coskew, cokurt, delta1, delta2, delta3, delta4)
